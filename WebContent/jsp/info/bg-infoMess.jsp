...
<%@ page import="com.miaomiao.bean.InfoMess"%>
...
<html>
  ...
  {  
  document.getElementById('ShowDiv').innerHTML = '请稍后，系统将在'+num+'秒后为您跳转...' ;
         ...
         <table width="788" border="0" align="center" cellpadding="0" cellspacing="0">
             <tr>
               ...
               <td width="618" align="center" valign="top" bgcolor="#FFFFFF">
	                  ...
	                  <bean:write name="infoMess" property="mess"/>
	                  <script type="text/javascript">
	                  Load("<bean:write name="infoMess" property="url"/>");
	                  </script>
	                  <div id="ShowDiv"></div>
