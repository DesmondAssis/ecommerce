...
<%@ page import="com.desmond.ec.order.intf.Order"%>
...
<body background="${path}/image/bg1.jpg">
    ...
    <!--end:右侧01-->
     ...
     <form  action="#">
		<table align="center">
			<tr>
				<td>【搜索 商品】
					<input type="text" size="20" name="goods"/>&nbsp;&nbsp;
...
<form method="post">
	<table width="550" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    <td colspan="3" background="${path}/image/bg_02.jpg" height="25">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;最新商品</td>
	  </tr>
	  <tr>
	  ...
	  <tr>
	    <td align="center">
	    	<a href="LiXiaoChuan/fg-goodsContent.jsp">
	    		<img src="${path}/image/11.jpg" alt="" title="" border="0" />
	    	</a>
	    </td>
	    <td align="center"><a href="LiXiaoChuan/fg-goodsContent1.jsp"><img src="${path}/image/12.jpg" alt="" title="" border="0" /></a></td>
	    <td align="center"><a href="LiXiaoChuan/fg-goodsContent2.jsp"><img src="${path}/image/13.jpg" alt="" title="" border="0" /></a></td>
	  </tr>
	  <tr>
	 ...
	 <tr>
	  ...
	  <tr>
	    <td colspan="3" background="${path}/image/bg_02.jpg" height="25">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;推荐商品</td>
	  </tr>
	  <tr>
