...
<table width="766" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
   ...
   <html:form action="getPwd.jsp" onSubmit="return checkEmpty(form)">
     <table width="298"  border="0" cellspacing="0" cellpadding="0" bordercolor="#FFFFFF" bordercolordark="#819BBC" bordercolorlight="#FFFFFF">
      <tr>
        ...
        <td width="187"><div align="center">
          <html:hidden property="username" value="add"></html:hidden>
          <html:hidden property="question" value="add"></html:hidden>
        </div></td>
      </tr>
       <tr>
        <td width="105" height="35">
