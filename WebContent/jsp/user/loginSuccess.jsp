	...
	<table width="766" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td width="207" valign="top" bgcolor="#F5F5F5">
				<!--左侧01--> <jsp:include page="fg-left-success.jsp" flush="true" /></td>
			<td width="559" valign="top" bgcolor="#FFFFFF">
				<!--右侧01-->
				<form name="form4">
					<table align="center">
						<tr>
							<td><select name="bigtype" onchange="getSmallType()">
							...
							</select> &nbsp;&nbsp; <select name="smalltype">
									<option value="smalltype" selected="selected">细分类别</option>
							</select> <input type="text" size="25" value="请输入您要查询的商品" />&nbsp;&nbsp;<input
								type="submit" value="查询" onclick="window.location='#'" /></td>
						</tr>
					</table>
				</form>
				<form method="post">
