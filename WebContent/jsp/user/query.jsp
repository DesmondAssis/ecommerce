...
<table width="766" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="207" valign="top" bgcolor="#F5F5F5"><!--左侧01-->
    <jsp:include page="fg-left-success.jsp" flush="true"/><br></td>
    <td width="559" valign="top" bgcolor="#FFFFFF">
    <!--右侧01-->	

    <div align="center">
        <table width="558" height="85" border="0" cellpadding="0" cellspacing="0" background="../../image/fg41.jpg">
          <tr>
            <td>&nbsp;</td>
          </tr>
        </table>
 ...
 <tr>
    ...
    <br>
    <a href="update.jsp"><img src="../../image/update.jpg"/></a>
    &nbsp;&nbsp;
    <a href="loginSuccess.jsp"><img src="../../image/back.gif"/></a>
