...
<table width="766" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <html:form action="answer.jsp" onSubmit="return checkEmpty(form)">
    
    <table width="298"  border="0" cellspacing="0" cellpadding="0" bordercolor="#FFFFFF" bordercolordark="#819BBC" bordercolorlight="#FFFFFF">
    <tr>
       <td width="105" height="35" bgcolor="#fffff">
        <div align="right">会员名:</div></td>
        <td width="187"><html:text property="username"></html:text>
        </td>
      </tr>
    </table>
