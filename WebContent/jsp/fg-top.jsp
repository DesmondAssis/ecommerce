...
<body>
<%--
	<table width="766" height="83" border="0" align="center"
		cellpadding="0" cellspacing="0" background="../image/h1.jpg">
		<tr>
			<td>&nbsp;</td>
		</tr>
	</table>
	<table width="766" border="0" align="center" cellpadding="0"
		...
		bordercolordark="#819BBC" background="../image/top1.jpg">
		<tr align="center">
			...
			<td width="117"
				onMouseOver="this.style.backgroundImage='url(../image/fg_top04.jpg)'"
				onMouseOut="this.style.backgroundImage=''"><a
				href="ZhangYing/listquery.jsp" class="a4">查看订单</a></td>
			<td width="117"
				onMouseOver="this.style.backgroundImage='url(image/fg_top04.jpg)'"
				onMouseOut="this.style.backgroundImage=''"><a
				href="LiWei/buyer.jsp" class="a4">购物车</a></td>

			<td width="117"
				onMouseOver="this.style.backgroundImage='url(image/fg_top04.jpg)'"
				onMouseOut="this.style.backgroundImage=''"><a href="#"
				onclick="this.style.behavior='url(#default#homepage)';this.sethomepage('http://www.mingrisoft.com')"
				class="a4">设为首页</a></td>
		</tr>
	</table>
